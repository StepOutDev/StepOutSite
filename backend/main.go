...
func main() {
	...
	bannerMongo := repositories.NewBannerRepository(mongodb)
	...
	bannerService := services.NewBannerService(bannerMongo,userService)

	gateways.NewHTTPGateway(app, userService, kneepadsService,eventService, bannerService)
