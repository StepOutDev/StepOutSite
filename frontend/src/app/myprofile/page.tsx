...
const ProfilePage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-[#E8DEF8]"
        ...
        <h1 className="flex items-center justify-center w-full text-[75px] font-extrabold absolute top-[90px] text-[#7F62AC] drop-shadow-md transition-transform transform ">My Profile</h1>{/*hover:scale-105*/}
        {/* Profile Picture */}
        <img
      ...
      <div className='rounded-3xl bg-[#F2D3EF] flex-col flex items-center w-[900px] h-[300px] mx-auto p-6 text-[#184A92] relative shadow-2xl absolute top-[185px]'>
        ...
        {/* Name */}
        <h1 className="flex items-center justify-center w-full text-2xl font-bold absolute top-[15px]">{userProfile.knickname}</h1>
        <div className='flex flex-row absolute w-full absolute top-[55px]'>
            <div className='flex flex-col w-[500px] h-[170px] absolute left-[50px] top-[0px] justify-between h-full'>
            ...
            <div className='flex flex-col w-[300px] h-[170px] absolute left-[570px] top-[0px] justify-between h-full'>
