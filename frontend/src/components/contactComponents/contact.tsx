export default function Contact() {
    return (
        <div id="contact"
            className=" relative w-full mt-[5%] bg-[#7A4E9A] overflow-hidden"
        >
            <div 
            ...
            <div className="relative flex md:flex-row flex-col w-full ml-[10%] mb-[40px]">
                ...
                {/* Follow me section */}
                <div className="flex flex-row text-white items-start p-5 space-x-5">
                ...
                {/* Contact section */}
                <div className="flex flex-row text-white items-start p-5 space-x-7">
