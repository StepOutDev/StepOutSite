    ...
    <div>
      <label htmlFor="fileInput" className="cursor-pointer">
        <img
          src={imageUrl}
          alt="event"
          className="w-full h-[250px] object-cover px-2 py-2 border-2 border-[#7A4E9A] bg-white text-[14px] sm:text-[14px] lg:text-[16px] text-black rounded-3xl"
        />
        <button
            type="button"
