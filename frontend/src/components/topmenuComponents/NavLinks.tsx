...
export default function NavLinks({cookie, user}:NavLinksProps){
    ...
    return (
        <div className="flex items-center justify-end space-x-2 h-full">
                <Link
                    href="/"
                    className="flex items-center justify-center space-x-2 h-full py-2 pr-4 pl-3 text-black duration-300 ease-in-out hover:bg-[#7A4E9A] hover:text-white"
                    title="Home"
                    >
                        <svg 
                        ...
                        <span className="self-center font-sans font-semibold hidden md:flex">Home</span>
                </Link>
                { cookie? 
                    (
                        <Link
                        ...
                        <span className="self-center font-sans font-semibold hidden md:flex">Member</span>
                        </Link>
                    ): null
                }
                <a
                    href="/#contact"
                    className="flex items-center justify-center space-x-2 h-full py-2 pr-4 pl-3 text-black font-bold duration-300 ease-in-out hover:bg-[#7A4E9A] hover:text-white"
                    title="Contact"
                    >
                        <svg 
                            xmlns="http://www.w3.org/2000/svg" 
                        ...
                        <span className="self-center font-sans font-semibold hidden md:flex">Contact</span>
                </a>
                {cookie? 
                    (
